        ...
        <div class="video-block-content">
            <template v-if="vod.is_converting">
                <em>
                    ...
                    Converting <strong>{{ vod.basename }}.{{ vod.provider === 'streamlink' || vod.provider === 'rtsp' || vod.provider === 'ytdlp' ? 'mp4' : 'ts' }}</strong> to <strong>{{ vod.basename }}.{{ store.cfg("vod_container", "mp4") }}</strong>
                </em>
                <br />
                <em>
            ...
            <template v-else-if="vod && vod.is_capturing">
                <em class="text-overflow">
                    ...
                    Capturing to <strong>{{ vod.basename }}.{{ vod.provider === 'streamlink' || vod.provider === 'rtsp' || vod.provider === 'ytdlp' ? 'mp4' : 'ts' }}</strong> (<strong>{{
